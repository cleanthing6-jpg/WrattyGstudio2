...
const TIERS = [
  ...
  },
  {
    ...
    price: "₦3,000",
    period: "/month",
    features: ["5 beat generations", "3 album covers", "Mix "3 mix & master downloads" master previews", "Full-length beats"],
    cta: "Get Starter",
    color: "green",
  },
  {
    ...
    price: "₦7,000",
    period: "/month",
    features: ["12 beat generations", "6 album covers", "Mix "10 mix & master downloads" master previews", "Priority processing"],
    cta: "Get Pro",
    color: "yellow",
  },
  {
    ...
    price: "₦15,000",
    period: "/month",
    features: ["20 beat generations", "10 album covers", "1 pro mix "30 mix & master downloads" master", "Fastest processing", "Commercial license"],
    cta: "Get Studio",
    color: "red",
  },
];
