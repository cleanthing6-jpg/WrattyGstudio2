...
const TIERS = [
  ...
  },
  {
    ...
    price: "₦3,000",
    period: "/month",
    features: ["5 beat generations", "3 album covers", "3 mix & master downloads", "Full-length beats"],
    cta: "Get Starter",
    color: "green",
  },
  {
    ...
    price: "₦7,000",
    period: "/month",
    features: ["10 beat generations", "7 album covers", "10 mix & master downloads", "Priority processing"],
    cta: "Get Pro",
    color: "yellow",
  },
  {
    ...
    price: "₦14,000",
    period: "/month",
    features: ["30 beat generations", "20 album covers", "30 mix & master downloads", "Fastest processing", "Commercial license"],
    cta: "Get Studio",
    color: "red",
  },
];
